...
mêmes indices rendent `BUS_LANES = 16` et `CLK_MEMCLK ≈ 2000 MHz`, et **refuse de servir**
sinon. Un mapping décalé publierait une tension comme une température.
...
- 🔴 **Coût propre, dn4-1 (5 métriques) : 1,528 % d'un cœur = 0,0955 % machine** —
  ...
  **3 %** du total. ⚠️ **Quelle lecture de « < 1 % » ?** Le brief ne le dit pas : **0,0955 %
  machine** ✅ (facteur 10 de marge, c'est ce qu'affiche le Gestionnaire des tâches) ·
  **1,528 % d'un cœur** ❌. Les deux sont publiées, comme dn2-2 le faisait déjà.
