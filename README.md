...
- la **console est interactive** : taper `aide` dans le moniteur liste les commandes. Jeu complet :
  ...
  `touch`, `nav`, `recal`, `bl`, `disp`, `dma`, `i2c` (`lire` · **`lire16`** · **`brut`** · **`ecrire`**), `capteurs`, `pc`, `wifi`, `widget`, `rtc`, `reboot`, `aide`. `cfg reset` rend
