...
| Câble USB-C données | quelconque, **données ET charge** | 1 | — | ⛔ **non relevé** | — | — |
...
la mauvaise. Il existe aussi une `2.8C` ronde en 480 × 480.
...
Ce qui **n'a pas** été fait, et qui reste ouvert : le démarrage à froid **sans aucun capteur du
tout**, et les conditions électriques d'un bus nu. La raison est écrite : il n'existe **qu'une seule
...
**Exactement** la carte ci-dessus, **plus ces deux modules**. ⛔ Rien d'autre.
...
| Fil de liaison | Dupont femelle-femelle, ~10 cm | 4 min. | — | ⛔ **non relevé** | — | — |
...
[les deux soudés](cablage/2026-08-20_0116-bh1750-et-ina219-barrettes-SOUDEES.jpg) ·
[le montage complet](cablage/2026-08-20_0951-montage-final-en-main-les-quatre-modules.jpg)
...
|---|---|
| `waveshare.com` (fiche produit officielle) | HTTP 403 |
| `mouser.fr` | délai dépassé à 60 s |
| `tinytronics.nl`, `eckstein-shop.de`, `octopart.com`, `adafruit.com` | HTTP 403 |
| `gotronic.fr`, `welectron.com` | HTTP 404 |
| `berrybase.de` | page rendue, **aucune fiche produit** |
| `thepihut.com` | page rendue, « no results found » |
